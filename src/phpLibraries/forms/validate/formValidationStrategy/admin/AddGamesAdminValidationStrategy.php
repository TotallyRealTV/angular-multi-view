<?
	...
	/**
	 *	AddGamesAdminValidationStrategy.php
	 *
	 *	Created:
	 *	2012-03-29
	 *
	...
	*/
		...
		class AddGamesAdminValidationStrategy extends BaseAdminValidationStrategy implements FormValidationStrategyInterface {
			...
			public function validateForm($obj) {
				...
				// check file name (only for embedded games)
