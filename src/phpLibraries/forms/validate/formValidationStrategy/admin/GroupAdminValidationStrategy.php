<?
	...
	*/
		...
		include_once(PHP_PATH . "forms/validate/vo/admin/GroupAdminMessagingVO.php");
  		
		class GroupAdminValidationStrategy extends BaseAdminValidationStrategy implements FormValidationStrategyInterface {
			...
			public function validateForm($obj) {
				...
				if ($this->formAction == "add") $errorCode = $this->checkDuplicateEntry($obj);
			...
			protected function generateMessaging() {
				$this->message = new GroupAdminMessagingVO();
			}
		}
