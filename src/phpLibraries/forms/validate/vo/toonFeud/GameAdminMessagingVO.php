	...
	*/
	...
	class GameAdminMessagingVO {
		...
		private function setupProps() {
			...
			$this->messages = array("Your game record has been created.", "Your game record has been updated.", "Update not performed. No data has changed.", "A game with that ID already exists.", "The game ID you entered is not valid.", "", "All of your date_time fields must be in the format: yyyy-mm-dd hh:mm:ss (ie: 2013-03-30 12:15:25)");
		}
