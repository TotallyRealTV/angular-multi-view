...
<?
	...
	$query->type = "selectIn";
	$query->language = "en";	
	$query->data = array("id", "admin_name", "display_name", "content_details");
	...
	$query->conditionalRange->field = "id";
	$query->conditionalRange->values = array("1", "4", "50", "80");
...
<h1>SELECT IN TEST DATA FAIL:</h1>
