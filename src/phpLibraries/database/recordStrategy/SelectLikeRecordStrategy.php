<?
	...
	*/
		...
		class SelectLikeRecordStrategy extends BaseRecordStrategy implements RecordStrategyInterface {
		 ...
		 */	 
			public function execute($obj) {
				...
				if (isset($obj->likeFrontRange)) {
					foreach ($obj->likeFrontRange as $key => $value) {
						$likeFrontBind[":".$key] = $value;	
					}
				}
				...
				if (isset($obj->likeFrontRange)) {
					foreach ($obj->likeFrontRange as $key=>$value) {
						$where .= $key . " LIKE'" . $likeFrontBind[":".$key] . "%' AND ";
					}
				}
