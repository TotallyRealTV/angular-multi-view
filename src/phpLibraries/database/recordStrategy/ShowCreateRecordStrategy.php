<?
	...
	*/
		...
		class ShowCreateRecordStrategy extends BaseRecordStrategy implements RecordStrategyInterface {
		 ...
		 */	 
			public function execute($obj) {
				...
				$result->data = $this->db->showCreate($obj->templateTable);
