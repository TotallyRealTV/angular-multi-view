<?
	 ...
	 *	$json = (object) NULL;
		...
		if ($isSuccess == true) {
			...
			$json->data->gameData = $gameData;
			$json->data->powerupData = $powerupData;
		}
	...
	class CampTeletoonGamesJsonOutput extends IJSONOutput {
		...
		protected function generateData() {
			...
			$this->json->data->gameData = $this->props->gameData;
			$this->json->data->powerupData = $this->props->powerupData;
		}
