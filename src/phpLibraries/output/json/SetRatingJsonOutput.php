<?
	...
	/**
	 *	This class generates and returns standard JSON Output structures for Setting Content Ratings across all brands:
	 *
	 *	Structure:
	 *	$json = (object) NULL;
	...
	class SetRatingJsonOutput extends IJSONOutput {
